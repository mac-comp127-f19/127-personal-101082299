...
//        canvas.add(bigSmiley);
        GraphicsGroup reallyBro = createReallyFace(300);
        reallyBro.setPosition(350, 200);
        canvas.add(reallyBro);
    ...
    public static GraphicsGroup createSmileyFace(double size) {
        ...
        // TODO: create eyes
        Ellipse leftEye = new Ellipse(size *.25,size*.25, size*.1, size*.1);
        leftEye.setFillColor(BLACK_COLOR);
        group.add(leftEye);
        Ellipse rightEye = new Ellipse(size *.75,size*.25, size*.1, size*.1);
        rightEye.setFillColor(BLACK_COLOR);
        group.add(rightEye);
    ...
    public static GraphicsGroup createReallyFace(double size){
        GraphicsGroup group = new GraphicsGroup();
        group.add(createHead(size,size));

        Rectangle leftEye = new Rectangle(size*.25, size*.25, size*.25, size*.01);
        leftEye.setFillColor(BLACK_COLOR);
        leftEye.setCenter(size*.3333,size*.3333);
        group.add(leftEye);
        Rectangle rightEye = new Rectangle(size*.7, size*.25, size*.25, size*.01);
        rightEye.setFillColor(BLACK_COLOR);
        rightEye.setCenter(size*.666666,size*.333333);
        group.add(rightEye);

        Rectangle mouth = new Rectangle(size*.7,size*.75,size*.4,size*.01);
        mouth.setFillColor(BLACK_COLOR);
        mouth.setCenter(size*.5,size*.5);
        group.add(mouth);
